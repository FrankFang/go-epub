...
type toc struct {
	...
	//
	// Sample: https://github.com/FrankFang/epub-samples/blob/master/minimal-v3plus2/EPUB/nav.xhtml
	...
	//
	// Sample: https://github.com/FrankFang/epub-samples/blob/master/minimal-v3plus2/EPUB/toc.ncx
